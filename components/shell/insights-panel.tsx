...
import { AlertTriangle, Clock, Inbox, Activity, CheckCircle2, Sparkles, CalendarClock, Target, Contact } from 'lucide-react';
import type { NotificationItem, ActivityFeedItem } from '@/lib/server/data/workspace';

const ATT_ICON = { overdue: AlertTriangle, due_soon: Clock, review: Inbox, reminder: Sparkles, meeting: CalendarClock, target: Target, lead: Contact } as const;
const ATT_TONE = { overdue: 'text-danger', due_soon: 'text-warning', review: 'text-accent', reminder: 'text-info', meeting: 'text-accent', target: 'text-warning', lead: 'text-accent' } as const;
